      ...
      <Container as={Stack} maxW={'6xl'} py={10}>
        <SimpleGrid
          ...
          <Stack spacing={6}>
            <HStack gap="3">
              ...
              <HStack alignItems="end">
                    <Text fontSize="2xl" px="1" mb="-1" fontFamily="Burrito" fontWeight="900" color="main">LOS POLLOS ANALOS</Text>
                </HStack>
            </HStack>
            <Text fontSize={'sm'}>
          ...
          <Stack align={'flex-start'}>
            ...
            <a href={'https://t.me/justinternetmoneyz'} target='_blank' style={{ color: "#6D68DE" }} rel="noreferrer">Kira</a>
          </Stack>
          <Stack align={'flex-start'}>
