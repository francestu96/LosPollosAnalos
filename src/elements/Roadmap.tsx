...
const Roadmap = () => {
    return (
        <Center borderBottomWidth="thin" width="full" id="roadmap" p="10" textColor="gray.700" backdropBlur="10px" backgroundImage="/roadmap-bg.jpg" backgroundPosition="center" backgroundSize="cover" textAlign="center">
          <VStack width="inherit" color="black">
            <Text fontSize="5xl" color="gray.800" fontFamily="Burrito">ROADMAP</Text>
            <VStack backgroundColor="rgb(250,250,250,0.8)" _hover={{ boxShadow: "0px 0px 10px rgba(255,255,255,0.5);", cursor: "pointer"}} p="10" width={["85%", "80%", "75%", "70%"]} borderWidth="thin" borderColor="gray.700" borderRadius="2xl">
              <Text fontSize={["lg", "xl", "3xl", "5xl"]} fontWeight="500" fontFamily="Burrito" color="main">
                The community
              </Text>
